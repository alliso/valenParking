...
public class fauvoriteAdapter extends RecyclerView.Adapter<fauvoriteAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.v.setBackgroundColor(parkings.isSelected() ? context.getResources().getColor(R.color.colorMenuText) : context.getResources().getColor(R.color.colorBgApp));
            ...
            holder.lytParent.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    if(!aux) {
                        ...
                        holder.lytParent.setBackgroundColor(parking.isSelected() ? context.getResources().getColor(R.color.colorMenuText) : context.getResources().getColor(R.color.colorBgApp));
